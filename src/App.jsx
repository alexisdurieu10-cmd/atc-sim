...
const SCENARIOS = [
  ...
  {
    id: 'scenario_6',
    title: 'Matinée chargée + 2 avions',
    description:
      "Même situation qu'au scénario 1 avec deux avions supplémentaires : F-GS (arrivée depuis Lyon) et F-DM (départ vers Dijon). Circuit à 3 appareils simultanés.",
    color: '#f97316',
    icon: 'layers',
    setup: { wind: '250°/10 kt', qnh: '1020', rwy: '27' },
